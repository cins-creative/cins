...
export const SCHEMA_TABLE_DOCS: Record<string, string> = {
  ...
  org_chi_nhanh: "Chi nhánh cơ sở đào tạo.",
  org_goi_hoc_phi: "Gói học phí (số ngày + giá).",
  org_don_hoc_phi: "Đơn thu học phí (VietQR / tiền mặt).",
  org_ky_hoc: "Khoảng ngày đã đóng tiền — nguồn freeze phòng lớp.",
  org_tien_do_bai: "Bài tập hiện tại của học viên trên enrollment.",
  org_nop_bai: "Bài học viên nộp / duyệt.",
  org_diem_danh: "Điểm danh lớp × ngày.",
