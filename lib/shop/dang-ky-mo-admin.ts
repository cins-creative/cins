...
const SELECT_COLS =
  "id, ten_shop, ten_lien_he, loai_hang, hinh_thuc_ban, resource_links, ghi_chu, kenh_lien_he, lien_he_gia_tri, email, ngan_hang, so_tai_khoan, ten_chu_tk, da_co_tai_khoan, link_profile_cins, nguoi_gioi_thieu, trang_thai, ghi_chu_noi_bo, id_nguoi_dung, id_cua_hang, nguon, tao_luc, cap_nhat_luc";
