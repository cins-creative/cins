/**
 * Chạy migration_shop_dia_chi_nhan.sql trên CINS.
 * Usage: node scripts/run-shop-dia-chi-nhan-migration.mjs
 *   hoặc: npm run migrate:shop-dia-chi-nhan
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_dia_chi_nhan.sql",
);
...
try {
  ...
  console.log("OK: shop_dia_chi_nhan (sổ địa chỉ nhận hàng) + RLS owner");
} catch (err) {
