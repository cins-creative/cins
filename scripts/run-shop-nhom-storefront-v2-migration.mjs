/**
 * Chạy migration_shop_nhom_storefront_v2.sql trên CINS.
 * Usage: node scripts/run-shop-nhom-storefront-v2-migration.mjs
 *   hoặc: npm run migrate:shop-nhom-storefront-v2
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_nhom_storefront_v2.sql",
);
...
try {
  ...
  console.log("OK: shop_nhom.anh_id + shop_nhom_danh_gia");
} catch (err) {
