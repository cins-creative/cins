/**
 * Chạy migration_shop_don_ma_don.sql trên CINS.
 * Usage: node scripts/run-shop-don-ma-don-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_don_ma_don.sql",
);
...
try {
  ...
  console.log("OK: shop_don_hang.ma_don");
} catch (err) {
