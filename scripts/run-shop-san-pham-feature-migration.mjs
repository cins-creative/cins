/**
 * Chạy migration_shop_san_pham_feature.sql trên CINS.
 * Usage: node scripts/run-shop-san-pham-feature-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_san_pham_feature.sql",
);
...
try {
  ...
  console.log("OK: shop_san_pham.noi_bat (Feature)");
} catch (err) {
