/**
 * Chạy migration_shop_cua_hang_da_xoa.sql trên CINS.
 * Usage: node scripts/run-shop-cua-hang-da-xoa-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_cua_hang_da_xoa.sql",
);
...
try {
  ...
  console.log("OK: shop_cua_hang.da_xoa + public RLS");
} catch (err) {
