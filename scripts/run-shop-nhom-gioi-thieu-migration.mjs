/**
 * Chạy migration_shop_nhom_gioi_thieu.sql trên CINS.
 * Usage: npm run migrate:shop-nhom-gioi-thieu
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_nhom_gioi_thieu.sql",
);
...
try {
  ...
  console.log("OK: shop_nhom_gioi_thieu");
} catch (err) {
