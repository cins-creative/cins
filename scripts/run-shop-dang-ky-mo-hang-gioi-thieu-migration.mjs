/**
 * Chạy migration_shop_dang_ky_mo_hang_gioi_thieu.sql trên CINS production.
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_dang_ky_mo_hang_gioi_thieu.sql",
);
...
try {
  ...
  console.log("OK: shop_dang_ky_mo.hang_gioi_thieu");
} catch (err) {
