/**
 * Chạy migration_lop_hoc_chi_nhanh.sql (junction lớp ↔ chi nhánh).
 * Usage: node scripts/run-lop-hoc-chi-nhanh-migration.mjs
 *        npm run migrate:lop-chi-nhanh
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_lop_hoc_chi_nhanh.sql",
);
...
console.log("CREATE org_lop_hoc_chi_nhanh + backfill từ id_chi_nhanh …");
...
try {
  ...
  console.log("OK: org_lop_hoc_chi_nhanh");
} catch (err) {
