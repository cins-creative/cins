/**
 * Chạy migration_shop_the_khach.sql trên CINS production.
 * Usage: node scripts/run-shop-the-khach-migration.mjs
 *        npm run migrate:shop-the-khach
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_the_khach.sql",
);
...
try {
  ...
  console.log("OK: shop_the_khach + shop_the_khach_gan + RLS + seed backfill");
} catch (err) {
