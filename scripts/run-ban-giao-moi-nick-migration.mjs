/**
 * Chạy migration_ban_giao_moi_nick.sql
 * Usage: npm run migrate:ban-giao-moi-nick
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_ban_giao_moi_nick.sql",
);
...
try {
  ...
  console.log("OK: migration_ban_giao_moi_nick.sql");
} catch (err) {
