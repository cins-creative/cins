/**
 * Chạy migration_shop_san_pham_phan_loai.sql trên CINS.
 * Usage: node scripts/run-shop-san-pham-phan-loai-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_san_pham_phan_loai.sql",
);
...
try {
  ...
  console.log("OK: shop_san_pham.phan_loai");
} catch (err) {
