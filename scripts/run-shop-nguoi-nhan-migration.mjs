/**
 * Chạy migration_shop_nguoi_nhan.sql trên CINS.
 * Usage: node scripts/run-shop-nguoi-nhan-migration.mjs
 *   hoặc: npm run migrate:shop-nguoi-nhan
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_nguoi_nhan.sql",
);
...
try {
  ...
  console.log(
    "OK: user_nguoi_dung.ho_ten_nhan (+visibility) · shop_don_hang.mua_ho_ten/mua_so_dien_thoai/mua_dia_chi",
  );
} catch (err) {
