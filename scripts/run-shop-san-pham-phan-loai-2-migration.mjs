/**
 * Chạy migration_shop_san_pham_phan_loai_2.sql trên CINS.
 * Usage: node scripts/run-shop-san-pham-phan-loai-2-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_san_pham_phan_loai_2.sql",
);
...
try {
  ...
  console.log("OK: shop_san_pham.phan_loai_2");
} catch (err) {
