/**
 * Chạy migration_autopilot_tuong_tac.sql
 * Usage: npm run migrate:autopilot-tuong-tac
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_autopilot_tuong_tac.sql",
);
...
try {
  ...
  console.log("OK: migration_autopilot_tuong_tac.sql");
} finally {
