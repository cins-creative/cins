/**
 * Chạy migration_shop_tru_kho_atomic.sql trên CINS.
 * Usage: node scripts/run-shop-tru-kho-atomic-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_tru_kho_atomic.sql",
);
...
try {
  ...
  console.log("OK: shop_tru_kho_bien_the / shop_hoan_kho_bien_the");
} catch (err) {
