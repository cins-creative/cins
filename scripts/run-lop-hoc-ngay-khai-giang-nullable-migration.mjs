/**
 * Chạy migration_lop_hoc_ngay_khai_giang_nullable.sql
 * Usage: node scripts/run-lop-hoc-ngay-khai-giang-nullable-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_lop_hoc_ngay_khai_giang_nullable.sql",
);
...
console.log("ALTER org_lop_hoc.ngay_khai_giang DROP NOT NULL …");
...
try {
  ...
  console.log("OK: org_lop_hoc.ngay_khai_giang nullable");
} catch (err) {
