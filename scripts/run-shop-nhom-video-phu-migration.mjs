/**
 * Chạy migration_shop_nhom_video_phu.sql trên CINS.
 * Usage: npm run migrate:shop-nhom-video-phu
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_nhom_video_phu.sql",
);
...
try {
  ...
  console.log("OK: shop_nhom.video_phu_id");
} catch (err) {
