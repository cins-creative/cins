/**
 * Chạy migration_shop_cua_hang_banner_su_kien_hien.sql trên CINS.
 * Usage: npm run migrate:shop-cua-hang-banner-hien
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_cua_hang_banner_su_kien_hien.sql",
);
...
try {
  ...
  console.log("OK: shop_cua_hang.banner_su_kien_hien");
} catch (err) {
