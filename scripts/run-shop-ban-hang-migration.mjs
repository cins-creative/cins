/**
 * Chạy migration_shop_ban_hang.sql trên CINS production.
 * Usage: node scripts/run-shop-ban-hang-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_ban_hang.sql",
);
...
try {
  ...
  console.log("OK: shop_* tables + ban_hang flags + RLS (L33)");
} catch (err) {
