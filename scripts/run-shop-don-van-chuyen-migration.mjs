/**
 * Chạy migration_shop_don_van_chuyen.sql — cột van_chuyen_link trên đơn.
 * Usage: npm run migrate:shop-don-van-chuyen
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_don_van_chuyen.sql",
);
...
try {
  ...
  console.log("OK: shop_don_hang.van_chuyen_link");
} catch (err) {
