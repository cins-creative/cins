/**
 * Chạy migration_shop_cua_hang_tam_dong_ly_do.sql trên CINS.
 * Usage: node scripts/run-shop-cua-hang-tam-dong-ly-do-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_cua_hang_tam_dong_ly_do.sql",
);
...
try {
  ...
  console.log("OK: shop_cua_hang.tam_dong_ly_do");
} catch (err) {
