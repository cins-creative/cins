/**
 * Chạy migration_shop_nhom_overlay.sql trên CINS.
 * Usage: npm run migrate:shop-nhom-overlay
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_nhom_overlay.sql",
);
...
try {
  ...
  console.log("OK: shop_nhom.overlay_anh_id");
} catch (err) {
