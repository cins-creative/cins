/**
 * Chạy migration_content_share_link.sql trên CINS production.
 * Usage: node scripts/run-content-share-link-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_content_share_link.sql",
);
...
try {
  ...
  console.log("OK: content_share_link + server-only RLS");
} catch (err) {
