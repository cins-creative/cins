/**
 * Chạy migration_shop_nhom_anh_phu.sql trên CINS.
 * Usage: npm run migrate:shop-nhom-anh-phu
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_nhom_anh_phu.sql",
);
...
try {
  ...
  console.log("OK: shop_nhom.anh_phu_ids");
} catch (err) {
