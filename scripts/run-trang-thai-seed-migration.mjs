/**
 * Chạy migration_trang_thai_seed.sql
 * Usage: npm run migrate:trang-thai-seed
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_trang_thai_seed.sql",
);
...
try {
  ...
  console.log("OK: migration_trang_thai_seed.sql");
} finally {
