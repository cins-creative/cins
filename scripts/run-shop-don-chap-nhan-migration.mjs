/**
 * Chạy migration_shop_don_chap_nhan.sql trên CINS.
 * Usage: node scripts/run-shop-don-chap-nhan-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_don_chap_nhan.sql",
);
...
try {
  ...
  console.log("OK: shop_don_hang.nguoi_mua_chap_nhan_*");
} catch (err) {
