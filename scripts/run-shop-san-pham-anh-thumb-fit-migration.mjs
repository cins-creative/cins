/**
 * Chạy migration_shop_san_pham_anh_thumb_fit.sql trên CINS.
 * Usage: node scripts/run-shop-san-pham-anh-thumb-fit-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_san_pham_anh_thumb_fit.sql",
);
...
try {
  ...
  console.log("OK: shop_san_pham.anh_thumb_fit");
} catch (err) {
  console.error(err);
  process.exit(1);
} finally {
