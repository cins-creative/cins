/**
 * Chạy migration_shop_don_van_chuyen_ma.sql — ĐVVC + mã vận đơn.
 * Usage: npm run migrate:shop-don-van-chuyen-ma
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_don_van_chuyen_ma.sql",
);
...
try {
  ...
  console.log("OK: shop_don_hang.van_chuyen_ma + van_chuyen_dvvc");
} catch (err) {
