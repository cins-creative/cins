/**
 * Chạy migration_user_giao_dien.sql trên Supabase Postgres.
 * Usage: node scripts/run-user-giao-dien-migration.mjs
 *        npm run migrate:giao-dien
 */
  ...
  const cols = await db.unsafe(
    `SELECT column_name, data_type, column_default, is_nullable
      ...
      WHERE table_schema = 'public'
        ...
        AND column_name = 'giao_dien'`,
  );
  console.log("OK: user_nguoi_dung.giao_dien");
  console.table(cols);
} catch (err) {
