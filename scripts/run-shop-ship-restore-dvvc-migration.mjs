/**
 * Khôi phục bảng/cột ĐVVC sau reverse.
 * Usage: npm run migrate:shop-ship-restore-dvvc
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_ship_restore_dvvc.sql",
);
...
try {
  ...
  console.log(
    "OK: shop ship restore ĐVVC — tables kho/ket-noi/log + cột ship trên đơn",
  );
} catch (err) {
