/**
 * Chạy migration_bao_cao_lua_dao.sql trên CINS.
 * Usage: node scripts/run-bao-cao-lua-dao-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_bao_cao_lua_dao.sql",
);
...
try {
  ...
  console.log("OK: loai_bao_cao_enum + lua_dao");
} catch (err) {
