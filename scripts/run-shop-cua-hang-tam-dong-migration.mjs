/**
 * Chạy migration_shop_cua_hang_tam_dong.sql trên CINS.
 * Usage: node scripts/run-shop-cua-hang-tam-dong-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_cua_hang_tam_dong.sql",
);
...
try {
  ...
  console.log("OK: shop_cua_hang.tam_dong / tam_dong_tu / tam_dong_den");
} catch (err) {
