/**
 * Chạy migration_shop_cua_hang_banner_su_kien.sql trên CINS.
 * Usage: npm run migrate:shop-cua-hang-banner
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_cua_hang_banner_su_kien.sql",
);
...
try {
  ...
  console.log("OK: shop_cua_hang.banner_su_kien_id");
} catch (err) {
