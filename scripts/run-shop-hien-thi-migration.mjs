/**
 * Chạy migration_shop_hien_thi.sql trên CINS production.
 * Usage: node scripts/run-shop-hien-thi-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_hien_thi.sql",
);
...
try {
  ...
  console.log("OK: user_nguoi_dung.shop_hien_thi");
} catch (err) {
