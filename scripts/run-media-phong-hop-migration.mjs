/**
 * Chạy migration_media_phong_hop.sql (L34 Plan 2 Phase A).
 * Usage: node scripts/run-media-phong-hop-migration.mjs
 *        npm run migrate:media-phong-hop
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_media_phong_hop.sql",
);
...
console.log("CREATE media_phong_hop …");
...
try {
  ...
  console.log("OK: media_phong_hop (Plan 2 Phase A)");
} catch (err) {
