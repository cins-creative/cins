/**
 * Chạy migration_shop_nhom.sql trên CINS.
 * Usage: node scripts/run-shop-nhom-migration.mjs
 *   hoặc: npm run migrate:shop-nhom
 */
...
const sqlPath = path.join(__dirname, "../supabase/sql/migration_shop_nhom.sql");
...
try {
  ...
  console.log("OK: shop_nhom + shop_san_pham.id_nhom / id_nhom_2 (backfill)");
} catch (err) {
