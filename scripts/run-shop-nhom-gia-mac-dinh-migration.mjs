/**
 * Chạy migration_shop_nhom_gia_mac_dinh.sql trên CINS.
 * Usage: npm run migrate:shop-nhom-gia
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_nhom_gia_mac_dinh.sql",
);
...
try {
  ...
  console.log("OK: shop_nhom.gia_mac_dinh");
} catch (err) {
