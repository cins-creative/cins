/**
 * Chạy migration_shop_gio_cua_hang.sql trên CINS.
 * Usage: node scripts/run-shop-gio-cua-hang-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_gio_cua_hang.sql",
);
...
try {
  ...
  console.log("OK: shop_gio id_cua_hang + scope (post | cửa hàng)");
} catch (err) {
