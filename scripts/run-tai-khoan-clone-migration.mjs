/**
 * Chạy migration_tai_khoan_clone.sql
 * Usage: npm run migrate:tai-khoan-clone
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_tai_khoan_clone.sql",
);
...
try {
  ...
  console.log("OK: migration_tai_khoan_clone.sql");
} finally {
