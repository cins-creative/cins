/**
 * Chạy migration_shop_nhom_feature.sql trên CINS.
 * Usage: npm run migrate:shop-nhom-feature
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_nhom_feature.sql",
);
...
try {
  ...
  console.log("OK: shop_nhom.noi_bat");
} catch (err) {
