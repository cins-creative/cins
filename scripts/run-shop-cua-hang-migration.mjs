/**
 * Chạy migration_shop_cua_hang.sql trên CINS.
 * Usage: node scripts/run-shop-cua-hang-migration.mjs
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_cua_hang.sql",
);
...
try {
  ...
  console.log("OK: shop_cua_hang + shop_phuong_thuc_tt + thanh_toan_snapshot");
} catch (err) {
