/**
 * Chạy migration_shop_dang_ky_mo.sql trên CINS production.
 * Usage: node scripts/run-shop-dang-ky-mo-migration.mjs
 *        npm run migrate:shop-dang-ky-mo
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_dang_ky_mo.sql",
);
...
try {
  ...
  console.log("OK: shop_dang_ky_mo + enums + RLS (service role only)");
} catch (err) {
