/**
 * Chạy migration_shop_dang_ky_mo_email_optional.sql trên CINS production.
 */
...
const sqlPath = path.join(
  __dirname,
  "../supabase/sql/migration_shop_dang_ky_mo_email_optional.sql",
);
...
try {
  ...
  console.log("OK: shop_dang_ky_mo.email nullable");
} catch (err) {
