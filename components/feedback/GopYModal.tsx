...
export function GopYModal({ open, onClose }: Props) {
  ...
  return createPortal(
    <div className="gopy-backdrop" role="presentation" onClick={onClose}>
      <div
      ...
      >
        ...
        <p className="gopy-sub">
          Hiện dự án đang ở giai đoạn beta nên có thể sẽ gặp lỗi, các bạn giúp
          CINs góp ý để cải thiện nha!
          <br />
          Nếu bạn cần thêm tính năng hay chỗ nào bất hợp lý cũng có thể góp ý để
          mình cân nhắc sửa
        </p>
