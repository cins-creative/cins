...
const NAV = [
  { section: "Nội dung" },
  { href: "/admin/articles", label: "Bài viết", icon: "doc" },
  { href: "/admin/content", label: "Nội dung đăng", icon: "grid" },
  ...
  { href: "/admin/transactions", label: "Giao dịch", icon: "cart" },
  { href: "/admin/disputes", label: "Tranh chấp shop", icon: "flag" },
  { href: "/admin/feedback", label: "Góp ý", icon: "message" },
  { href: "/admin/mo-shop", label: "Mở shop", icon: "cart" },
  { href: "/admin/catalog", label: "Danh mục hàng", icon: "tag" },
  { href: "/admin/guides", label: "Hướng dẫn", icon: "book" },
  { section: "Tổ chức" },
  { href: "/admin/to-chuc", label: "Tổ chức", icon: "org" },
  { href: "/admin/majors", label: "Ngành đào tạo", icon: "edu" },
  { href: "/admin/exam-subjects", label: "Môn & khối thi", icon: "subject" },
  { section: "Users" },
  ...
  { href: "/admin/fields", label: "Lĩnh vực", icon: "grid" },
