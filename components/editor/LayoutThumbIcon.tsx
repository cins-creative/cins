...
function buildThumbs(variant: ThumbVariant): Record<ImgLayout, ReactNode> {
  ...
  return {
    ...
    duo: (
      <>
        <T x={1} y={1} w={7.5} h={12} />
        <T x={9.5} y={1} w={7.5} h={12} />
      </>
    ),
    grid2: (
      <>
        <T x={1} y={1} w={7.5} h={3.4} />
        <T x={9.5} y={1} w={7.5} h={3.4} />
        <T x={1} y={5.3} w={7.5} h={3.4} />
        <T x={9.5} y={5.3} w={7.5} h={3.4} />
        <T x={1} y={9.6} w={7.5} h={3.4} />
        <T x={9.5} y={9.6} w={7.5} h={3.4} />
      </>
    ),
    grid3: (
      <>
        <T x={1} y={1} w={4.6} h={5.4} />
        <T x={6.7} y={1} w={4.6} h={5.4} />
        <T x={12.4} y={1} w={4.6} h={5.4} />
        <T x={1} y={7.6} w={4.6} h={5.4} />
        <T x={6.7} y={7.6} w={4.6} h={5.4} />
        <T x={12.4} y={7.6} w={4.6} h={5.4} />
      </>
    ),
    grid4: (
      <>
        <T x={1} y={1} w={7.5} h={5.4} />
        <T x={9.5} y={1} w={7.5} h={5.4} />
        <T x={1} y={7.6} w={7.5} h={5.4} />
        <T x={9.5} y={7.6} w={7.5} h={5.4} />
      </>
    ),
    hero: (
      <>
        <T x={1} y={1} w={16} h={7.5} />
        <T x={1} y={9.4} w={4.9} h={3.6} />
        <T x={6.55} y={9.4} w={4.9} h={3.6} />
        <T x={12.1} y={9.4} w={4.9} h={3.6} />
      </>
    ),
  };
}
