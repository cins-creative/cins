/** Skeleton trang chủ logged-in — token CINS / j-skel (DEV_RULES §8). Content-aware cột giữa. */
    ...
    >
      <div className="wj-shell">
        ...
        <div className="wj-feed">
          {/* Khớp wj-feed-header + filter bar */}
          <div
            className="j-skel"
            style={{ height: 48, width: "100%", marginBottom: 12, borderRadius: 14 }}
          />
          {/* Composer */}
          <div
            className="j-skel"
            style={{ height: 72, width: "100%", marginBottom: 16, borderRadius: 14 }}
          />
              ...
              <div className="j-m-card jcard j-skel-post-card">
                <div className="jcard-datebar">
                  ...
                  <div className="j-skel-post-badges">
                    ...
                    <div className="j-skel j-skel-post-badge" style={{ width: "40%" }} />
                  </div>
                </div>
                <div className="jcard-body">
                  <div className="j-skel j-skel-post-line j-skel-post-line--title" />
                  <div className="j-skel j-skel-post-line" style={{ width: "88%" }} />
          ...
          <article className="j-milestone">
            <div className="j-m-body-wrap">
              <div className="j-m-card jcard j-skel-post-card">
                ...
                <div className="jcard-body">
                  <div className="j-skel j-skel-post-line j-skel-post-line--title" />
                  <div className="j-skel j-skel-post-line" style={{ width: "70%" }} />
                  <div
                    className="j-skel"
                    style={{
                      height: 180,
