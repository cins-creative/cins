...
import { KhoaHocQuanLyClient } from "@/components/co-so/quan-ly/KhoaHocQuanLyClient";
...
export default async function Page({ params }: Props) {
  ...
  return (
    <CoSoQuanLyPageGate params={params} section="lop-hoc">
      <KhoaHocQuanLyClient orgId={meta.id} orgSlug={slug} />
    </CoSoQuanLyPageGate>
  );
}
