...
import { GiaoTrinhQuanLyClient } from "@/components/co-so/quan-ly/GiaoTrinhQuanLyClient";
...
export default async function Page({ params }: Props) {
  ...
  return (
    <CoSoQuanLyPageGate params={params} section="giao-trinh">
      <GiaoTrinhQuanLyClient orgId={meta.id} orgSlug={slug} />
    </CoSoQuanLyPageGate>
  );
}
