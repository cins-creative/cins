...
import { ToChucListingLoader } from "@/app/to-chuc/_components/ToChucListingLoader";
import { ToChucListingSkeleton } from "@/app/to-chuc/_components/ToChucListing.skeleton";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: HUB_TITLE,
    description: HUB_DESC,
    images: [{ url: "/to-chuc/opengraph-image", alt: HUB_TITLE }],
  },
  twitter: {
    card: "summary_large_image",
    title: HUB_TITLE,
    description: HUB_DESC,
    images: ["/to-chuc/opengraph-image"],
  },
};
