...
import { NganhHocHubLoader } from "@/app/majors/_components/NganhHocHubLoader";
import { NganhHocHubSkeleton } from "@/app/majors/_components/NganhHocHub.skeleton";
...
export default async function NganhHocIndexPage(props: {
  ...
  const listParams = { q: sp.q, nhom: sp.group };
