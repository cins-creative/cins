...
export const alt = "Khóa học & ngành đại học ngành sáng tạo trên CINs";
    ...
    (
      <OgCardRoot>
        ...
        >
          ...
          >
            <OgEyebrow label="Học nghề sáng tạo" />
            <div
              style={{
                fontSize: 62,
                fontWeight: 800,
            ...
            >
              Khóa học online &amp; offline từ các cơ sở đào tạo — so sánh học phí,
              hình thức và trình độ đầu vào.
            </div>
          </div>
          ...
          >
            <OgUrlPill>cins.vn/tim-khoa-hoc</OgUrlPill>
