...
import { TimKhoaHocHubShell } from "@/app/find-courses/_components/TimKhoaHocHubShell";
import {
  TKH_KHOA_PAGE_SIZE,
  TKH_NGANH_HUB_SAMPLE,
} from "@/app/find-courses/_components/tim-khoa-hoc-page-size";
import {
  timKhoaHocHubHref,
  type TimKhoaHocLoai,
} from "@/app/find-courses/_components/tim-khoa-hoc-params";
