...
import { transferCongDongOwnership } from "@/lib/cong-dong/members";

type RouteContext = { params: Promise<{ id: string }> };

/** POST /api/cong-dong/:id/transfer-owner — bàn giao quyền sở hữu. */
export async function POST(req: Request, ctx: RouteContext) {
  ...
  const result = await transferCongDongOwnership({
    orgId,
