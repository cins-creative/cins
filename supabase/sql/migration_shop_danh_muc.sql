...
VALUES
  ...
  ('charm-keychain', 'Charm, keychain & coaster', 'merch',
   'Charm, móc khóa, coaster — cùng nhóm phụ kiện đeo/rời. Chất liệu → facet chat-lieu.', 20, 'hien'),
  ('charm-coaster', 'Charm & coaster rời', 'merch',
   'Đã gộp vào charm-keychain (Rev 3). Giữ slug để URL cũ redirect.', 20, 'an'),
  ('keychain', 'Keychain & móc khóa', 'merch',
   'Đã gộp vào charm-keychain (Rev 3). Giữ slug để URL cũ redirect.', 30, 'an'),
  ...
  ('trung-bay', 'Phụ kiện trưng bày', 'merch',
   'Vật đựng/đỡ để trưng bày món khác (hộp shaker, khung, kệ). Bản thân món được trưng bày → danh mục của nó.', 120, 'hien'),
